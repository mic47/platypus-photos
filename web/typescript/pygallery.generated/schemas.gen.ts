...
export const AggregateQuerySchema = {
    properties: {
        query: {
...
export const AnnotationOverlayInterpolateLocationSchema = {
    properties: {
        t: {
            type: 'string',
...
export const AnnotationOverlayNoLocationSchema = {
    properties: {
        t: {
            type: 'string',
            enum: ['NoLocation'],
...
export const DateClusterSchema = {
    properties: {
        example_path_md5: {
            type: 'string',
...
export const DateClusterGroupSchema = {
    properties: {
        address_name: {
            anyOf: [
                {
...
export const DateClusterGroupBySchema = {
    type: 'string',
    enum: ['country', 'camera', 'has_location', 'address_name'],
    title: 'DateClusterGroupBy'
} as const;

export const DateClusterParamsSchema = {
    properties: {
        url: {
            '$ref': '#/components/schemas/SearchQuery'
        },
...
export const DirectoryStatsSchema = {
    properties: {
        directory: {
            type: 'string',
            title: 'Directory'
...
export const ExceptionInfoSchema = {
    properties: {
        exc_type: {
            anyOf: [
                {
...
export const FaceFeatureRequestSchema = {
    properties: {
        md5: {
            type: 'string',
            title: 'Md5'
...
export const FaceIdentifierSchema = {
    properties: {
        md5: {
            type: 'string',
            title: 'Md5'
...
export const FaceWithMetaSchema = {
    properties: {
        position: {
            '$ref': '#/components/schemas/Position'
        },
...
export const FacesResponseSchema = {
    properties: {
        has_next_page: {
            type: 'boolean',
            title: 'Has Next Page'
...
export const FoundLocationSchema = {
    properties: {
        latitude: {
            type: 'number',
            title: 'Latitude'
...
export const GalleryPagingSchema = {
    properties: {
        page: {
            type: 'integer',
            title: 'Page',
...
export const GalleryRequestSchema = {
    properties: {
        query: {
            '$ref': '#/components/schemas/SearchQuery'
        },
...
export const GetAddressRequestSchema = {
    properties: {
        latitude: {
            type: 'number',
            title: 'Latitude'
...
export const IdentityRowPayloadSchema = {
    properties: {
        identity: {
            type: 'string',
            title: 'Identity'
...
export const IdentitySkipReasonSchema = {
    type: 'string',
...
export const ImageAddressSchema = {
    properties: {
        country: {
            anyOf: [
                {
...
export const ImageAggregationSchema = {
    properties: {
        total: {
            type: 'integer',
            title: 'Total'
...
export const ImageWithMetaSchema = {
    properties: {
        omg: {
...
export const JobProgressRequestSchema = {
    properties: {
        state: {
            anyOf: [
                {
...
export const JobProgressStateSchema = {
    properties: {
        ts: {
            type: 'number',
            title: 'Ts'
...
export const JobProgressStateResponseSchema = {
    properties: {
        state: {
            '$ref': '#/components/schemas/JobProgressState'
        },
...
export const LocClusterParamsSchema = {
    properties: {
        nw: {
...
export const LocationBoundsSchema = {
    properties: {
        nw: {
            '$ref': '#/components/schemas/LocPoint'
        },
...
export const LocationClusterSchema = {
    properties: {
        example_path_md5: {
            type: 'string',
            title: 'Example Path Md5'
...
export const LocationQueryFixedLocationSchema = {
    properties: {
        t: {
            type: 'string',
            enum: ['FixedLocation'],
...
export const ManualIdentityClusterRequest_InputSchema = {
    properties: {
        identity: {
            anyOf: [
                {
...
export const ManualIdentityClusterRequest_OutputSchema = {
    properties: {
        identity: {
            anyOf: [
                {
...
export const ManualLocationSchema = {
    properties: {
        latitude: {
            type: 'number',
            title: 'Latitude'
...
export const ManualLocationOverrideSchema = {
    type: 'string',
    enum: ['NoLocNoMan', 'NoLocYeMan', 'YeLocNoMan', 'YeLocYeMan'],
    title: 'ManualLocationOverride'
} as const;

export const MapSearchResponseSchema = {
    properties: {
        response: {
            anyOf: [
                {
...
export const MassLocationAndTextAnnotation_InputSchema = {
    properties: {
        t: {
            type: 'string',
            enum: ['MassLocAndTxt'],
...
export const MassLocationAndTextAnnotation_OutputSchema = {
    properties: {
        t: {
            type: 'string',
            enum: ['MassLocAndTxt'],
...
export const PredictedLocationSchema = {
    properties: {
        loc: {
            '$ref': '#/components/schemas/LocPoint'
        },
...
export const ProgressBarProgressSchema = {
    properties: {
        desc: {
            anyOf: [
                {
...
export const ReferenceStatsSchema = {
    properties: {
        distance_m: {
            type: 'number',
            title: 'Distance M'
...
export const RemoteJobTypeSchema = {
    type: 'string',
    enum: ['mass_manual_annotation', 'face_cluster_annotation'],
    title: 'RemoteJobType'
} as const;

export const RemoteJob_bytes_Schema = {
    properties: {
        id_: {
            type: 'integer',
            title: 'Id '
...
export const TextAnnotationSchema = {
    properties: {
        description: {
            anyOf: [
                {
...
export const TextAnnotationOverrideSchema = {
    type: 'string',
    enum: ['ExMan', 'NoMan', 'YeMan'],
    title: 'TextAnnotationOverride'
} as const;

export const TextQueryFixedTextSchema = {
    properties: {
        t: {
            type: 'string',
            enum: ['FixedText'],
