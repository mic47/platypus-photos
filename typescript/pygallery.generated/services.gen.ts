 ...
 * @throws ApiError
 */
export const configExportDirsEndpointGet = (): CancelablePromise<ConfigExportDirsEndpointGetResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const exportPhotosToDirGet = (data: ExportPhotosToDirGetData): CancelablePromise<ExportPhotosToDirGetResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/export_to_dir',
    query: {
        query: data.query,
